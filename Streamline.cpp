...
void Streamline::DoExecute()
{
  ...
  {
    std::cout << "Domain does not contain specified vector field for ParticleAdvection analysis." << std::endl;
  }
  ...
  if (!validField)
  {
    std::cout<< "Vector field type does not match <vtkm::Vec<vtkm::Float32,3>> or <vtkm::Vec<vtkm::Float64,3>>" << std::endl;
  }
